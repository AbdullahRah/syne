...
const defaultFAQs: FAQItem[] = [
  {
    question: "What is Syne Autonomous and how does it work?",
    answer:
      "Syne Autonomous is an AI-powered intelligence layer that connects all your communication tools—calls, chats, and meetings—into a unified system. It analyzes conversations in real-time to provide insights on sentiment, tone, team alignment, and collaboration patterns. Simply integrate Syne Autonomous with your existing tools like Slack, Zoom, or Microsoft Teams, and start gaining actionable insights immediately.",
  },
  {
    question: "How does Syne Autonomous use my data to build a custom AI chat?",
    answer:
      "Syne Autonomous processes your communication data using advanced natural language processing and machine learning models. All data is encrypted end-to-end and processed in compliance with enterprise-grade security standards. Your data is never shared with third parties, and you maintain complete control over what gets analyzed. The AI learns from patterns in your team's communication to provide personalized insights specific to your organization.",
  },
  {
    question: "How do I get started with Syne Autonomous and what are the pricing options?",
    answer:
