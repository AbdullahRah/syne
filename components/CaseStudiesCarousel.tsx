...
const caseStudies: CaseStudy[] = [
  {
    id: "alberta-builders",
    company: "Alberta Builders Ltd.",
    logo: (
      <div className="flex items-center gap-2 font-bold text-xl uppercase tracking-tighter">
        <div className="w-8 h-8 bg-black text-white flex items-center justify-center rounded">A</div>
        Alberta Builders
      </div>
    ),
    title: "Alberta Builders uses Syne Autonomous to audit code compliance across 15 simultaneous job sites.",
    features: ["Automated QC", "Jurisdiction Checks", "Verified Reports"],
    quote: "Syne Autonomous cut our pre-inspection rework by 40%. The ROI was immediate.",
    attribution: "Dave Miller, Project Director, Alberta Builders",
    accentColor: "#000000",
    cards: [],
  },
  {
    id: "city-inspect",
    company: "Metro Calgary Inspections",
    logo: (
      <div className="flex items-center gap-2 font-bold text-xl uppercase tracking-tighter">
        <div className="w-8 h-8 bg-emerald-600 text-white flex items-center justify-center rounded">M</div>
        Metro Calgary
      </div>
    ),
    title: "Metro Calgary leverages Syne's building code engine to speed up residential approvals by 3x.",
    features: ["Instant Search", "Policy Alignment", "AI Verification"],
    quote: "Our inspectors now have a digital partner that handles the manual lookup, letting them focus on safety.",
    attribution: "Sarah Jenkins, Chief Building Official",
    accentColor: "#10b981",
    cards: [],
  },
]
    ...
    >
      <div className="max-w-7xl w-full">
        ...
        <div className="text-center mb-16">
          ...
          >
            See how leading teams use Syne Autonomous to gain clarity on collaboration and team alignment.
          </p>
        </div>
