...
const metrics = [
  {
    ...
    suffix: "%",
    prefix: "",
    label: "SMB insurance applications rejected",
  },
  {
    value: 100,
    suffix: "K",
    prefix: "$",
    label: "Per-person fine under new privacy law",
  },
  {
    value: 1,
    suffix: ".2M+",
    prefix: "",
    label: "Canadian employer businesses",
  },
  {
    value: 30,
    suffix: " min",
    prefix: "",
    label: "Time to get compliant with syneOps",
  },
];
